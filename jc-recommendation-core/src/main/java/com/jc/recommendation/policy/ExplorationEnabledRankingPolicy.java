...
public record ExplorationEnabledRankingPolicy(
        ...
        String expectedExplorationPolicyVersion,
        ...
        String scoredMetadataCoverage,
        String explorationMetadataCoverage,
        String terminalMigration,
        String finalRankSource
) implements VersionedPolicy {
    public ExplorationEnabledRankingPolicy {
        ...
        Objects.requireNonNull(expectedExplorationPolicyVersion, "expectedExplorationPolicyVersion");
        ...
        Objects.requireNonNull(scoredMetadataCoverage, "scoredMetadataCoverage");
        Objects.requireNonNull(explorationMetadataCoverage, "explorationMetadataCoverage");
        Objects.requireNonNull(terminalMigration, "terminalMigration");
