...
The selector computes SHA-256 over algorithm version, salt version, salt material hash and approved hashed subject reference, then maps to 10,000 stable buckets. One percent selects buckets `0..99`; zero percent selects none. Allowlist approval precedes selection.
