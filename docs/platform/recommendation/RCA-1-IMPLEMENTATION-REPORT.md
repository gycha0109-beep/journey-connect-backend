...
Implemented package `com.jc.backend.recommendation.dataadoption.reconciliation` with immutable contracts, normalizer, synthetic identity policy, fixture reader, P1/P2 comparators, evidence writer, dependency-free runner, and independent verifier. Registered only the three SC-approved RCA-1 IDs.
