# RCA-1 Identity and Privacy Enforcement
...
Synthetic bindings support VALID, ABSENT, INVALID, EXPIRED, DELETED, MISMATCHED, UNAUTHORIZED_PURPOSE, and UNAUTHORIZED_CALLER. Every non-valid state fails closed. No anonymous, nearest-user, alternate-subject, numeric-ID inference, opaque-ID inference, or fixture identity reuse exists.
