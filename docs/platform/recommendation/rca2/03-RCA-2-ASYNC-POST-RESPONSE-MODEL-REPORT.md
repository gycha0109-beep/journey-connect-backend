# RCA-2 Async Post-Response Model Report

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** Response-commit ordering and primary-future decoupling
...
`OnCommittedResponseWrapper` invokes submission immediately before the underlying response commit. The task receives only immutable digests/checkpoint/lineage metadata and never joins or mutates the primary future.
