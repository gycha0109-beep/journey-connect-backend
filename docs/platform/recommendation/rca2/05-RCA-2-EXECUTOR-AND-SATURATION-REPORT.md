# RCA-2 Executor and Saturation Report

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** Concurrency 4, queue 100, 50ms offer timeout, non-caller execution
...
Dedicated `ArrayBlockingQueue(100)`, four daemon dispatchers, fixed four-thread runtime executor, `AbortPolicy`, no common pool, no cached pool, no CallerRunsPolicy, no retry.
