# RCA-2 P1 Mismatch Inventory

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** Independent expected/protected gap inventory
...
Expected/protected: `ORDERING_NOT_COMPARABLE`, `EVENT_GRAIN_MISSING`, `EXPLICIT_PREFERENCE_MISSING`, `TRANSFORM_POLICY_MISSING`, `FINGERPRINT_SEMANTICS_PROTECTED`. These do not increment unexpected mismatch counters. Unexpected digest/size/checkpoint/lineage mismatches discard the candidate.
