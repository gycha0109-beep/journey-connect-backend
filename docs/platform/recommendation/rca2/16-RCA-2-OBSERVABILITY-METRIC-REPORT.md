# RCA-2 Observability and Metric Report

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** Metric inventory, types, labels, buckets, owners, retention
...
Counters: shadow_request/execution/success/timeout/exception/circuit_open/queue_rejected/late_discard, P1/P2 mismatch, checkpoint/lineage mismatch, stale, identity blocked, redaction failure. Histograms: shadow_latency_ms, primary_latency_ms with 10/25/50/100/250/500/1000ms buckets. Labels: environment, lane, result_class, breaker_state only.
