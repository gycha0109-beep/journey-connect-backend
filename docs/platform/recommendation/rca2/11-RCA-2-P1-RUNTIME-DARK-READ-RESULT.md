# RCA-2 P1 Runtime Dark-Read Result

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** P1 lane contract comparison result
...
`P1_RESULT=CONTRACT_ADAPTER_MATCH_WITH_EXPECTED_PROTECTED_GAPS`; `CURRENT_P1_AUTHORITY_UNCHANGED`; `P1_SHADOW_RESULT_NOT_SERVED`. No aggregate-to-event-stream conversion occurs.
