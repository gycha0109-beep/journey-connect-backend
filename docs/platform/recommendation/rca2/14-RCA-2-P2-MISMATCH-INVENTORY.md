# RCA-2 P2 Mismatch Inventory

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** Migration and protected mismatch inventory
...
Migration gaps retained: `STALE_UNEXPOSED_ASSIGNMENT_GAP`, `OBSERVATION_DEDUPE_GAP`. General exposure, behavior impression, view/hide/report, unbound fallback, wrong assignment/version/variant/binding are authority mismatches. Canonical dataset hash and release evidence remain protected and unaccessed.
