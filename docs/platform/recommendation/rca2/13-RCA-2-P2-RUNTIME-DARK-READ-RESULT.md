# RCA-2 P2 Runtime Dark-Read Result

`ACTUAL_WORK_START_SHA=ed5708bd4da12eaea8180043f5cd7f6eb13c3099`

**Focus:** P2 lane authority/window/event/fallback comparison result
...
`P2_RESULT=CONTRACT_ADAPTER_MATCH_WITH_MIGRATION_GAPS`; exposure authority is `recommendation_p2_experiment_exposure`; window `[exposedAt, exposedAt+604800)`; events exactly click/like/save/share; fallback is bound recommendation run only; no authority transfer.
