# RCA-1 P1 Shadow Reconciliation Result
...
Executed 23 P1 cases. Baseline lane result is `RECONCILED_WITH_EXPECTED_GAPS`; baseline unexpected mismatch count is zero. Exact/shared, derived, and 7/30/90 aggregate dimensions use zero tolerance. Ordering, event grain, explicit preference, transform policy, and fingerprint semantics remain expected/protected gaps.
