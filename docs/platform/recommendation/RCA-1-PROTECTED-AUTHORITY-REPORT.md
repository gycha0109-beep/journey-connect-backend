# RCA-1 Protected Authority Report
...
No P1/P2 source, `jc-recommendation-core`, SQL, production configuration, RCA-0 contract/fixture/evidence, canonical P2 dataset hash, or release evidence is modified. P1 authority remains `RecommendationP1ProfileSource`; P2 authority remains `RecommendationP2ObservationSource` and `recommendation_p2_experiment_exposure`.
