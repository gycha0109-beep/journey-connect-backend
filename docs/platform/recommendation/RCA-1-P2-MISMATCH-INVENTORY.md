...
Generated a P2-only mismatch inventory. General exposure and behavior impression are exposure-authority mismatches; view/hide/report are protected differences; wrong window and unbound fallback block. Stale-unexposed assignment and persisted dedupe are `MIGRATION_REQUIRED`; canonical hash and release evidence are protected and not read or recalculated.
