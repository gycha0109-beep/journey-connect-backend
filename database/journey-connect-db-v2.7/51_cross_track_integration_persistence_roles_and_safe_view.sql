...
GRANT EXECUTE ON FUNCTION public.digest(bytea,text),public.data_event_canonical_json_v1(jsonb),public.gen_random_uuid() TO jc_data_integration_function_owner;
