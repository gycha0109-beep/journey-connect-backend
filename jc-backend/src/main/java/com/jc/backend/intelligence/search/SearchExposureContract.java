...
public final class SearchExposureContract {
    ...
    public static final String IDENTITY_MAPPING_VERSION = "identity-mapping-v1";
    public static final String IDENTITY_PURPOSE = "search-exposure-write";
    public static final String IDENTITY_REQUESTER = "intelligence-search";
    ...
    public static final String RETENTION_POLICY_VERSION = "search-exposure-retention-v1";
    ...
    public static final Duration RAW_RETENTION = Duration.ofDays(180);
