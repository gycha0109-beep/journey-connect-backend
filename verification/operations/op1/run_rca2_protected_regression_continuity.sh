...
python3 "$ROOT/verification/operations/op1/run_sc_baseline_reconciliation_continuity.py"
python3 "$ROOT/verification/operations/op1/run_data_platform_closure_continuity.py"
python3 "$ROOT/verification/dp6/run_dp6_allocation_verification.py"
python3 "$ROOT/verification/operations/op1/run_dp7_allocation_continuity.py"
