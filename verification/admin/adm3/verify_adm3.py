...
SUCCESSOR_COMPATIBILITY_SCOPE_PATHS = MAINTENANCE_SCOPE_PATHS | {
    ...
    "verification/operations/op2/run_data_platform_closure_continuity.py",
    "verification/operations/op2/run_dp6_allocation_continuity.py",
    "verification/operations/op2/run_dp7_allocation_continuity.py",
    "verification/operations/op2/run_dp7_static_continuity.py",
